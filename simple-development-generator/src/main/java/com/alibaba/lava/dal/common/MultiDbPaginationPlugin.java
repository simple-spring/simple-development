...
public class MultiDbPaginationPlugin extends PluginAdapter {
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addImportedType("com.alibaba.lava.base.LavaDo");
    ...
    public boolean modelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addImportedType("com.alibaba.lava.base.LavaExample");
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        new FullyQualifiedJavaType(ANNOTATION_RESOURCE);
        String doName = introspectedTable.getBaseRecordType();
        String exmpName = introspectedTable.getExampleType();
        FullyQualifiedJavaType lavaMapperType = new FullyQualifiedJavaType("com.alibaba.lava.base.LavaMapper" + "<" + doName + "," + exmpName + ">");
