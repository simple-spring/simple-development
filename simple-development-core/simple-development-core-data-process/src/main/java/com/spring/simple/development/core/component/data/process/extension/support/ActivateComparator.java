 ...
 */
package com.spring.simple.development.core.component.data.process.extension.support;
...
public class ActivateComparator implements Comparator<Object> {
    ...
    public int compare(Object o1, Object o2) {
        ...
        SimpleActivate a1 = o1.getClass().getAnnotation(SimpleActivate.class);
        SimpleActivate a2 = o2.getClass().getAnnotation(SimpleActivate.class);
        if ((a1.before().length > 0 || a1.after().length > 0
                || a2.before().length > 0 || a2.after().length > 0)
                && o1.getClass().getInterfaces().length > 0
                && o1.getClass().getInterfaces()[0].isAnnotationPresent(SimpleSPI.class)) {
