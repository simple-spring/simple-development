...
public class XxlJobSpiConfig implements SimpleSpiConfig<EnableXxlJob, XxlJobConfig> {

	@Override
	public Class<XxlJobConfig> getConfigClass(EnableXxlJob enableXxlJob) {
		try{
			...
			Class jobConfig = ClassLoadUtil.javassistCompile(XxlJobConfig.class, "org.springframework.context.annotation.ComponentScan", mapperPackageNames, "basePackages");
			return jobConfig;
		} catch(Exception ex) {
