package com.spring.simple.development.core.Idempotent;

import com.alibaba.fastjson.JSON;
import com.spring.simple.development.core.annotation.Idempotent;
...
public class IdempotentAspect {
    @Pointcut("@annotation(com.spring.simple.development.core.annotation.Idempotent)")
