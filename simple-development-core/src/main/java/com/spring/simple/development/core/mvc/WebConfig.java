package com.spring.simple.development.core.mvc;
...
import com.spring.simple.development.core.mvc.interceptor.ApiSupportInterceptor;
...
@Configurable
@EnableWebMvc
@ComponentScan(basePackages = {"com.spring.simple.development.core.mvc.controller"})
