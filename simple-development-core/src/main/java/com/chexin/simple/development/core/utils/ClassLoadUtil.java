...
public class ClassLoadUtil extends ClassLoader {
     ...
     **/
    public static Class javassistCompile(String className, String annotationName, List<String> packageNames, String simpleAnnotationName) throws NotFoundException, CannotCompileException {
        ClassPool classPool = ClassPool.getDefault();
        classPool.appendClassPath(new ClassClassPath(RootConfig.class));
