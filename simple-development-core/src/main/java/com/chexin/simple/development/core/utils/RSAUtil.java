...
public class RSAUtil {
	...
	public static  RSAUtil rsaUtil = null;
    /**保存生成的密钥对的文件名称。 */
    private static String RSA_PAIR_FILENAME;
    
    private final Logger LOGGER = LogManager.getLogger(RSAUtil.class);
    /** 算法名称 */
    ...
    public static synchronized RSAUtil getInstance(){
    	RSA_PAIR_FILENAME = "/__RSA_PAIR.jks";
    	if(rsaUtil == null){
    	    rsaUtil = new RSAUtil();
    	    return rsaUtil;
    	}
